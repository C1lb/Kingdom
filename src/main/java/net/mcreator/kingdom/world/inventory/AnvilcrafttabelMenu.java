...
package net.mcreator.kingdom.world.inventory;
...
public class AnvilcrafttabelMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public AnvilcrafttabelMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
