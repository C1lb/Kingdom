...
public class KingdomModMenus {
	...
	public static final RegistryObject<MenuType<AnvilcrafttabelMenu>> ANVILCRAFTTABEL = REGISTRY.register("anvilcrafttabel", () -> IForgeMenuType.create(AnvilcrafttabelMenu::new));
}
